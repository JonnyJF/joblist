...
export default (props) =>{
    ...
    const handleSubmit= async ()=>{
        for(const field in jobDetails){
            if(typeof jobDetails[field] === "string" && required[field] ) {
        ...
        <Dialog open={props.openModal} fullWidth>
            ...
            <DialogContent>
                ...
                <Box mt={2}>
                    ...
                    <Box display="flex">
                    <FilledInput onChange={handleChange} autoComplete="off" placeholder="Company URL*" disableUnderline fullWidth name="skills" value={jobDetails.skills}/>
